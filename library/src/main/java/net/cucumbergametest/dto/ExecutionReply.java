...
public class ExecutionReply implements Serializable {
    @Serial
    ...
    public ExecutionReply(String uniqueId, ExecutionType executionType) {
        this.uniqueId      = uniqueId;
        this.executionType = executionType;
    }

    public ExecutionReply(String uniqueId, String reason, ExecutionType executionType) {
        this(uniqueId, executionType);
        this.reason = reason;
    }

    public ExecutionReply(String uniqueId,
                          Path filePath,
                          String mediaType,
